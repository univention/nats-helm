...
* **deps:** Update gitregistry.knut.univention.de/univention/dev/nubus-for-k8s/common-helm/testrunner Docker tag to v0.29.10 ([ed08ae5](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/commit/ed08ae50e0603f7be8250f23fcdcbdf00c78e43c)), closes [#0](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/issues/0)

## [0.7.9](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/compare/v0.7.8...v0.7.9) (2026-02-11)


### Bug Fixes

* **deps:** Update dependency univention/dev/nubus-for-k8s/common-ci to v1.55.3 ([487265e](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/commit/487265e514555493b51a0567036f511cc2200a8c)), closes [#0](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/issues/0)

## [0.7.8](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/compare/v0.7.7...v0.7.8) (2026-01-24)


### Bug Fixes

* **deps:** Update dependency univention/dev/nubus-for-k8s/common-ci to v1.55.2 ([6d3dad6](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/commit/6d3dad6c49dc70bbb013351bdfa46be155591242)), closes [#0](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/issues/0)
...
* **deps:** Update dependency univention/dev/nubus-for-k8s/common-ci to v1.54.2 ([e8387d2](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/commit/e8387d267c796bba6f32ea1abcdd31ef389108e8)), closes [#0](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/issues/0)

## [0.7.5](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/compare/v0.7.4...v0.7.5) (2025-12-23)


### Bug Fixes

* **deps:** Update dependency univention/dev/nubus-for-k8s/common-ci to v1.54.1 ([2c876a5](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/commit/2c876a5fcc33bc5402f7c52dd1d94ac384485ce6)), closes [#0](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/issues/0)

## [0.7.4](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/compare/v0.7.3...v0.7.4) (2025-12-18)


### Bug Fixes

* **deps:** Update dependency univention/dev/nubus-for-k8s/common-ci to v1.54.0 ([6813f1b](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/commit/6813f1b0c2e3c592f729cbdf2028751e644dfb92)), closes [#0](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/issues/0)
...
* update nats to version 2.12.2 ([ed53533](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nats-helm/commit/ed535339d0387824cca058e61357b8b3f3076170)), closes [univention/dev/internal/team-nubus#1539](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1539)
